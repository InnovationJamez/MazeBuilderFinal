...
const old = () => {
    let sheet = "";
    sheet += "00000..0000000000..0";
    sheet += "0...0..0...00..0...0";
    sheet += "0...0..0...00..0...0";
    sheet += "0000000000000..00000";

    sheet += "0..0000000000..00000";
    sheet += "0......00...0..0....";
    sheet += "0......00...0..0....";
    sheet += "00000..00..00..00000";

    sheet += "0..000000..00..00..0";
    sheet += "........0......0....";
    sheet += "........0......0....";
    sheet += "00000..00..00..00..0";
    ...
    solCanvas.width = width * dim;
    solCanvas.height = height * dim;

    for (let i = 0; i < width; i++) {
        for (let j = 0; j < height; j++) {
            let color;
            if (sheet[j * width + i] == '0') {
                color = "red";
            }
            else {
                color = "black";
            ...
            sctx.fillRect(i * dim, j * dim, dim, dim);

            sctx.strokeStyle = "white";
            sctx.rect(i * dim, j * dim, dim, dim);
            sctx.stroke();
        }
    }
}